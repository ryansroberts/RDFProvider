    ...
    [ let ex = (NLP.graphOf scope s).Response.Entities |> Array.toList
      ...
      let rec body (ex : trResponse.Entity list) i = 
          [ match ex, i with
            ...
            | e :: tail, i -> 
                let annotationScope = 
                    (Scope("http://nice.org.uk/annotation", [ Identifier(System.Guid.NewGuid().ToString()) ]))
                ...
                yield! statementsFor (Subject targetUri) 
                           [ yield (a, Object.from specificResource.Uri)
                             ...
                             yield (Predicate.from specificResource.ObjectProperties.``oa:hasSource``.Uri, 
                                    Object.from (Owl.Uri(string scope)))
                             
                             yield (Predicate.from specificResource.ObjectProperties.``oa:hasSelector``.Uri, 
                                    Object.from selectorUri) ]
                yield! statementsFor (Subject selectorUri) [ yield (a, Object.from textPosition.Uri)
                                                             
                                                             yield (Predicate.from startPos.Uri, 
                                                                    Object.from e.StartingPos)
                ...
                yield! statementsFor (Subject(Owl.Uri(string annotationScope))) 
                           [ yield (a, Object.from annotation.Uri)
                             ...
                             yield (Predicate.from annotation.ObjectProperties.``oa:hasTarget``.Uri, 
                                    Object.from targetUri)
                             
                             yield (Predicate.from annotation.DataProperties.``oa:annotatedAt``.Uri, 
                                    Object.from (System.DateTimeOffset.Now))
                ...
                yield! statementsFor (Subject.from tagUri) 
                           [ yield (a, Object.from tag.Uri)
                             ...
                             yield (Predicate.from (Owl.Uri("http://www.w3.org/2002/07/owl#sameAs")), 
                                    Object.from 
                                        ((Owl.Uri("http://rdf.freebase.com/ns" + e.FreebaseId.Replace("m/", "m.")))))
                             yield (Predicate.from chars.Uri, Object.from (string e.EntityId)) ]
                yield! body tail (i + 1) ]
      yield! body ex 0 ]

let cite (scope : Scope) (st : Model.Study) (t : Owl.Object) = 
...
let study (st : Model.Study)  = 
    [ 
      ...
      let doi = (NLP.doiFor (st.References)) 
      yield! statementsFor (Subject(referenceUri))  
          [match doi with
          | Some(doi) -> 
              let doi = doi.Replace("http://dx.doi.org/","")
              yield (Predicate.from (Owl.Uri("http://www.w3.org/2002/07/owl#sameAs")),Object.from (Owl.Uri("http://dx.doi.org/" + doi)))
              yield! [match NLP.pubmedFor doi with
                    | Some(pmid) -> 
                        yield (Predicate.from (Owl.Uri("http://www.w3.org/2002/07/owl#sameAs")), 
                               Object.from (Owl.Uri("http://bio2rdf.org/pubmed:" + pmid)))
                    | _ -> () ]
          | _ -> () ]
      ]
...
let statement (scope : Scope) (st : Model.Statement) t = 
    [ let scope = Scope("http://nice.org.uk/evidencestatement", [ st.Id ])
      yield! statementsFor (Subject(Owl.Uri(string scope))) [ yield (a, Object.from evidenceStatement.Uri)
                                                              yield (a, individual)
                                                              yield (a, Object.from textContent.Uri)
                                                              
                                                              yield (Predicate.from chars.Uri, 
                                                                     Object.from (string st.Statement))
                                                              yield (Predicate.from isAbout.Uri, t) ]
      for s in st.Studies do
          yield! cite scope s (Object.from (Owl.Uri(string scope))) ]

let question (scope : Scope) (q : Model.Question) t = 
    [ let scope = scope.Enter q.Id
      yield! statementsFor (Subject(Owl.Uri(string scope))) [ yield (a, Object.from question.Uri)
                                                              yield (a, individual)
                                                              yield (a, Object.from textContent.Uri)
                                                              
                                                              yield (Predicate.from chars.Uri, 
                                                                     Object.from (string q.Text))
                                                              yield (Predicate.from isAbout.Uri, t) ] ]
    ...
    [ let guidanceScope = Owl.Uri((string scope))
      ...
      yield! statementsFor (Subject(Owl.Uri(string rationaleScope))) 
                 [ yield (a, Object.from rationale.Uri)
                   ...
                   yield (Predicate.from rationale.ObjectProperties.``nice:isRationaleOf``.Uri, 
                          Object.from (Owl.Uri(string scope))) ]
    ...
    [ let guidanceScope = scope
      ...
      yield! statementsFor (Subject(Owl.Uri(string scope))) 
                 [ yield (a, Object.from recommendation.Uri)
                   ...
                   yield (Predicate.from recommendation.DataProperties.``nice:identifier``.Uri, 
                          Object.from (string r.Id))
                   yield (Predicate.from recommendation.DataProperties.``nice:title``.Uri, Object.from (string r.Title))
                   
                   yield (Predicate.from isAbout.Uri, 
                          Object.from (Owl.Uri(string (Scope("http://nice.org.uk/topic", [ r.Set ])))))
                   yield (Predicate.from isPartOf.Uri, Object.from (Owl.Uri((string guidanceScope))))
                   
                   yield (Predicate.from recommendation.DataProperties.``nice:recommendationStrength``.Uri, 
                          Object.from r.Grade) ] ]
    ...
    [ let scope = Scope("http://nice.org.uk/guideline", [ g.Id ])
      yield! statementsFor (Subject(Owl.Uri(string scope))) 
                 [ yield (a, Object.from guideline.Uri)
                   ...
                   yield (Predicate.from guideline.DataProperties.``nice:issued``.Uri, 
                          Object.from (new System.DateTimeOffset(g.Issued))) ]
      for s in g.Sets do
          yield! topic scope s
    ...
    [ let scope = Scope("http://nice.org.uk/qualitystatement", [ statement.Id ])
      ...
      yield! statementsFor (Subject(Owl.Uri(string scope))) 
                 [ yield (a, Object.from qualityStatement.Uri)
                   ...
                   yield (Predicate.from qualityStatement.DataProperties.``nice:title``.Uri, 
                          Object.from (string statement.Title))
          ...
          for n in m.Numerators do
              ...
              yield! statementsFor (Subject(Owl.Uri(string scope))) 
                         [ yield (a, Object.from numerator.Uri)
                           ...
                           yield (Predicate.from numerator.ObjectProperties.``nice:isNumeratorOf``.Uri, 
                                  Object.from (Owl.Uri(string nscope))) ]
          for n in m.Denominators do
              ...
              yield! statementsFor (Subject(Owl.Uri(string scope))) 
                         [ yield (a, Object.from denominator.Uri)
                           ...
                           yield (Predicate.from denominator.ObjectProperties.``nice:isDenominatorOf``.Uri, 
                                  Object.from (Owl.Uri(string nscope))) ] ]
    ...
    [ let scope = Scope("http://nice.org.uk/qualitystandard", [ s.Id ])
      yield! statementsFor (Subject(Owl.Uri(string scope))) 
                 [ yield (a, Object.from qualityStandard.Uri)
                   ...
                   yield (Predicate.from qualityStandard.DataProperties.``nice:subject``.Uri, 
                          Object.from (string s.Subject)) ]
...
let organisation (o : Model.Organisation) = 
    [ let scope = Scope("http://nice.org.uk/organisations", [ o.Id ])
      yield! statementsFor (Subject(Owl.Uri(string scope))) [ yield (a, Object.from organisation.Uri)
                                                              yield (a, individual) ] ]
    ...
    [ let scope = Scope("http://nice.org.uk/sharedlearning", [ s.Id ])
      yield! statementsFor (Subject(Owl.Uri(string scope))) 
                 [ yield (a, Object.from sharedLearning.Uri)
                   ...
                   yield (Predicate.from sharedLearning.DataProperties.``nice:hasTitle``.Uri, 
                          Object.from (string s.Title))
                   
                   yield (Predicate.from sharedLearning.DataProperties.``nice:hasDescription``.Uri, 
                          Object.from (string s.Description))
                   
                   for o in s.Organisations do
                       let orgscope = Owl.Uri(string (Scope("http://nice.org.uk/organisations", [ o ])))
                       yield (Predicate.from sharedLearning.ObjectProperties.``nice:wasDevelopedBy``.Uri, 
                              Object.from orgscope)
    ...
    [ let scope = Scope("http://nice.org.uk/outcomesframework", [ o.Id ])
      yield! statementsFor (Subject(Owl.Uri(string scope))) 
                 [ yield (a, individual)
                   ...
                   yield (Predicate.from outcomesFramework.DataProperties.``nice:title``.Uri, 
                          Object.from o.FrameworkName)
                   
                   yield (Predicate.from outcomesFramework.DataProperties.``nice:dateIssued``.Uri, 
                          Object.from (new System.DateTimeOffset(o.Date))) ]
          ...
          yield! statementsFor (Subject(Owl.Uri(string dscope))) 
                     [ yield (a, individual)
                       ...
                       for i in d.Indicators do
                           yield (Predicate.from outcomesDomain.ObjectProperties.``nice:hasIndicator``.Uri, 
                                  Object.from (Owl.Uri("http://nice.org.uk/outcomeindicator/" + (string i)))) ] ]
      ...
      yield! statementsFor (Subject(Owl.Uri(string scope))) 
                 [ yield (a, individual)
                   ...
                   for qs in o.QualityStandards do
                       yield (Predicate.from outcomesIndicator.ObjectProperties.``nice:hasMeasure``.Uri, 
                              Object.from (Owl.Uri("http://nice.org.uk/qualitystandard/" + (string qs)))) ] ]
